...
describe("Given I am connected as an employee", () => {
  describe("When I am on NewBill Page", () => {
    ...
    describe("When I choose to import a file other than png, jpeg or jpg", () => {
      test("Then the supporting file submitted is not correct, the send button is disabled.", async () => {
    ...
    describe("When I choose to import a file like png, jpeg or jpg", () => {
      test("Then the supporting file submitted is correct, the send button is active.", async () => {
        ...
        const sendButton = screen.getByTestId("sumbit-btn");
        expect(fakeHandleChangeFile).toHaveBeenCalled();
        expect(sendButton.getAttribute("disabled")).toBe(null);
      });
    });
    ...
    test("Then i click in the <submit> button, with good values.", () => {
      ...
      //controle de changement de route
...
describe("Given I am a user connected as Employee", () => {
  describe("When I navigate to Bills Page", () => {
    test("Then the invoices are then added, API POST test.", async () => {
      ...
      const virtualHandleSubmit = jest.fn((e) => objNewBill.handleSubmit(e));
